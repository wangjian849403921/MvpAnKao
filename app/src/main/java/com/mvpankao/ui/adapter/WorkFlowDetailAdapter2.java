...
public class WorkFlowDetailAdapter2 extends BaseAdapter {
    private Context context;
    private List<WorkFlowDetailBean2.ObjectBean> list;
    private LayoutInflater inflater;
    SPUtils mSPUtils;

    public WorkFlowDetailAdapter2(Context context, List<WorkFlowDetailBean2.ObjectBean> list) {
        super();
