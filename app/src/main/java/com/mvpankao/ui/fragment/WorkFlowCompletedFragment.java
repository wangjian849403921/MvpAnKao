...
public class WorkFlowCompletedFragment extends BaseFragment implements WorkFlowView {
        ...
        switch (event.getMsg()) {
            case Constants.COMPLETED_CODE:
                ...
                if (mAdapter != null) {
                    ...
                    mAdapter = new WorkFlowAdapter(getActivity(), list);
    ...
    public void onSuccess() {
        hideProgress();
        EventBus.getDefault().post(new MyEvent(COMPLETED_CODE));
    }
