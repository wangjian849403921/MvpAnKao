...
public class OrderAllFragment extends BaseFragment implements OrderView {
    ...
    private void initData() {
        ...
        OrderPresenter.initData(getActivity(), mMyOkhttp, list);
    }

    @Subscribe(threadMode = ThreadMode.MAIN) //在ui线程执行
    public void MyEvent(MyEvent event) {
        switch (event.getMsg()) {
            case Constants.ALLORDER_CODE:
                if (itemsize <= Constants.SIZE) {
                    mOrderList.stopLoadingMore();
                    mOrderList.setLoadMoreEnable(false);
                }
                        ...
                        new AlertDialog(mContext).builder().setTitle("删除订单")
                                ...
                                .setPositiveButton("确定", new View.OnClickListener() {
                                    ...
                                    private void deleteOrder(String id) {
                                        OrderPresenter.deleteOrder(getActivity(), mMyOkhttp, id, position);
                                    }
    ...
    public void onSuccess() {
        ...
        EventBus.getDefault().post(new MyEvent(Constants.ALLORDER_CODE));
    }
