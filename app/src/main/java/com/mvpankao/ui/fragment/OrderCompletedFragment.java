...
public class OrderCompletedFragment extends BaseFragment implements OrderView {
    ...
    public void MyEvent(MyEvent event) {
        switch (event.getMsg()) {
            case Constants.ORDERCOMPLETE_CODE:
    ...
    public void onSuccess() {
        hideProgress();
        EventBus.getDefault().post(new MyEvent(Constants.ORDERCOMPLETE_CODE));
    }
