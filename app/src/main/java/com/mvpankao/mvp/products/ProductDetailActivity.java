...
import com.mvpankao.ui.activity.ShopCarActivity;
...
public class ProductDetailActivity extends MVPBaseActivity<ProductsContract.View,ProductsPresenter> implements ProductsContract.View {
...
//                }
    ...
    public void onSuccess(Object responses) {
        ProductDetailBean response=(ProductDetailBean)responses;
