 ...
 * On  2016/9/7
 */
public class ProductsFragment extends MVPBaseFragment<ProductsContract.View, ProductsPresenter> implements ProductsContract.View {
    ...
    private void initSelectData() {
       ...
       mPresenter.initSelectData(getActivity(),mMyOkhttp);
    }
