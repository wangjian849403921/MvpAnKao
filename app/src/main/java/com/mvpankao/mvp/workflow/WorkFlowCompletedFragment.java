...
import static com.mvpankao.utils.Constants.COMPLETED_CODE;
...
public class WorkFlowCompletedFragment extends MVPBaseFragment<WorkFlowContract.View, WorkFlowPresenter> implements WorkFlowContract.View {
    ...
    private void initData() {
        ...
        mPresenter.initData(getActivity(), mMyOkhttp, page,mSPUtils.getString("userid"),mSPUtils.getString("role"),"2");
    }
    ...
    public void onSuccess(Object responses) {
       ...
       itemsize=(response).getObject().getTotal();
        ...
        EventBus.getDefault().post(new MyEvent(Constants.COMPLETED_CODE));
    }
