...
public class WorkFlowExecutingFragment extends MVPBaseFragment<WorkFlowContract.View, WorkFlowPresenter> implements WorkFlowContract.View {
    ...
    private void initData() {
        ...
        mPresenter.initData(getActivity(), mMyOkhttp, page,mSPUtils.getString("userid"),mSPUtils.getString("role"),"1");
    }
