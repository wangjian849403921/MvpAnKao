...
public class CircleProgressView extends View
{
	...
	private void parseAttributes(TypedArray a)
	{
		...
		circleRadius = (int) a.getDimension(R.styleable.CircleProgressView_Prog_circleRadius, circleRadius);

		fillRadius = a.getBoolean(R.styleable.CircleProgressView_Prog_fillRadius, false);

		barWidth = (int) a.getDimension(R.styleable.CircleProgressView_Prog_barWidth, barWidth);

		rimWidth = (int) a.getDimension(R.styleable.CircleProgressView_Prog_rimWidth, rimWidth);

		float baseSpinSpeed = a.getFloat(R.styleable.CircleProgressView_Prog_spinSpeed, spinSpeed / 360.0f);
		spinSpeed = baseSpinSpeed * 360;

		barSpinCycleTime = a.getInt(R.styleable.CircleProgressView_Prog_barSpinCycleTime, (int) barSpinCycleTime);

		barColor = a.getColor(R.styleable.CircleProgressView_Prog_barColor, barColor);

		rimColor = a.getColor(R.styleable.CircleProgressView_Prog_rimColor, rimColor);

		linearProgress = a.getBoolean(R.styleable.CircleProgressView_Prog_linearProgress, false);

		if (a.getBoolean(R.styleable.CircleProgressView_Prog_progressIndeterminate, false))
		{
			spin();
		}
