...
public class AlertDialog {
    ...
    public AlertDialog setMsgColor(String color) {
        showMsg = true;
        if ("".equals(color)) {
            txt_msg.setTextColor(Color.parseColor("#000000"));
        } else {
    ...
    public AlertDialog setPositiveButtonColor(String color) {
        showPosBtn = true;
        if ("".equals(color)) {
            btn_pos.setTextColor(Color.parseColor("#000000"));
        } else {
    ...
    public AlertDialog setNegativeButtonColor(String color) {
        showNegBtn = true;
        if ("".equals(color)) {
            btn_neg.setTextColor(Color.parseColor("#000000"));
        } else {
