...
public class ActionSheetDialog {
     ...
     * @return
     */
    public ActionSheetDialog noCancleBtn() {
    ...
    /**
     * @param listItem 条目List
     * @param color    条目字体颜色，设置null则默认蓝色
     * @param listener
     * @return
     */
    public ActionSheetDialog addSheetItems(List<String> listItem, SheetItemColor color,
                                           OnSheetItemClickListener listener) {
        if (sheetItemList == null) {
            sheetItemList = new ArrayList<SheetItem>();
        }
        for (int i = 0; i < listItem.size(); i++) {
            sheetItemList.add(new SheetItem(listItem.get(i), color, listener));
        }
